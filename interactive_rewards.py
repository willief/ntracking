...
# Visualization
custom_hovertemplate = "Number: %{customdata[0]}<br>" + \
                       "Rewards balance: %{customdata[6]:.9f}<br>"
        ...
        xaxis=dict(
            rangeselector=dict(
                buttons=[
                    ...
                    #dict(count=30, label="Last 30 days", step="day", stepmode="backward"),
                ...
                font=dict(color="#993d00")  # Color of the range selector text
            ),
            type="date",
            showgrid=True, 
            gridcolor='#252526', 
...
df = enhanced_extract_data(file_list)
