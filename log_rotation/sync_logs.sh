...
mkdir -p "$DEST_BASE_DIR/system_23"
mkdir -p "$DEST_BASE_DIR/system_24"
mkdir -p "$DEST_BASE_DIR/system_25"
mkdir -p "$DEST_BASE_DIR/system_26"
mkdir -p "$DEST_BASE_DIR/system_27"
mkdir -p "$DEST_BASE_DIR/system_28"
mkdir -p "$DEST_BASE_DIR/system_29"
mkdir -p "$DEST_BASE_DIR/system_30"
